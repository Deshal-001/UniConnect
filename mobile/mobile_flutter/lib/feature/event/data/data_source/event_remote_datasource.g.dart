...
part of 'event_remote_datasource.dart';
...
class _EventApiRemoteDataSource implements EventApiRemoteDataSource {
  ...
  @override
  Future<List<EventModel>> findUniByLocation(String prefix) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'location': prefix};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<EventModel>>(Options(
      method: 'GET',
  ...
  @override
  Future<EventModel> bookEvent(int eventId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<List<EventModel>> findBookedEventsByUserId(int userId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
